...
async function registerCompany(companyCRN, companyName, location, organisationRole) {
	...
	try {
		...
		console.log('newCompanyBuffer',newCompanyBuffer);
...
/* registerCompany('002', 'VS Pharma', 'Delhi', 'Distributor').then(() => {
	console.log('Approve New Company Submitted on the Network');
}); */
